...
def opcao_invalida():
    '''Essa função é responsável por indicar uma opcão inválida'''
    print('Opção inválida!\n')
    voltar_ao_menu_principal()

def exibir_subtitulo(texto):
    '''Essa função é responsável por limpar o histórico, e formatar os subtítulos'''
    os.system('cls')
    linha = '*' * (len(texto))
    print(linha)
    print(texto)
...
def alternar_estado_restaurante():
    '''Essa função é responsável por alterar o status de um restaurante já cadastrado'''
...
def escolher_opcao():
    '''Essa função é responsável por verificar a opção do programa selecionada pelo usuário'''
    try:
...
def main():
    '''Essa função é responsável por limpar o histórico e iniciar o programa no menu principal'''
    os.system('cls')
